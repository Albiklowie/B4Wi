...
namespace _1._1_FDCForLabMonitoringSystem
{
    ...
    public partial class RecogniseFace : Form
    {
        //unlock upon recognize
        ...
        private void RecogniseFace_Shown(object sender, EventArgs e)
        {
        ...
        private void RecogniseFace_Load(object sender, EventArgs e)
        {
            timer1.Start();
            ...
            foreach (MCvAvgComp f in facesDetected[0])
            {
                ...
                if (trainingImages.ToArray().Length != 0)
                {
                    ...
                    if (DataAccess.IsStudent(name))
                    {
                        ...
                        UserIdTextbox.Text = dt.Rows[0][1].ToString();
                        FirstNameTextbox.Text = dt.Rows[0][2].ToString();
                        LastNameTextbox.Text = dt.Rows[0][3].ToString();
                        ...
                        if (DataAccess.IsInstructorIn(Convert.ToInt32(name), _scheduleId))
                        {
                            ...
                            if(TimeInOption.Checked)
                            {
                                DataAccess.WriteAttendanceIN(Convert.ToInt32(name), DateTime.Now.Date, DateTime.Now, DateTime.Now, _scheduleId);
                            }
                            else if(TimeOutOption.Checked)
                            {
                                DataAccess.WriteAttendanceOut(Convert.ToInt32(name), DateTime.Now.Date, DateTime.Now, DateTime.Now, _scheduleId);
                            }
                            //DataAccess.WriteAttendanceIN(Convert.ToInt32(name), DateTime.Now.Date, DateTime.Now, DateTime.Now, _scheduleId);
                            Unlock();
                        }
...

                    {
                        ...
                        label4.Text = "Instructor Detected";
                       ...
                       // TimeinTextbox.Text = dtA.Rows[0][3].ToString();
        ...
        //WAY LABOT
        private void TimeInOption_CheckedChanged(object sender, EventArgs e)
        {

        }

        //WAY LABOT
        private void TimeOutOption_CheckedChanged(object sender, EventArgs e)
        {
