...
namespace _1._1_FDCForLabMonitoringSystem
{
    ...
    /// </summary>
    [Serializable]
    public class EigenObjectFaceRecognizer
    {
        ...
        private EigenObjectFaceRecognizer()
        {
        }
        ...
        public EigenObjectFaceRecognizer(Image<Gray, Byte>[] images, ref MCvTermCriteria termCrit)
        ...
        /// <param name="termCrit">The criteria for recognizer training</param>
        public EigenObjectFaceRecognizer(Image<Gray, Byte>[] images, String[] labels, ref MCvTermCriteria termCrit)
        ...
        /// </param>
        /// <param name="termCrit">The criteria for recognizer training</param>
        public EigenObjectFaceRecognizer(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
        {
